...
('New Vaccination Policy Update', 'Government announces new vaccination guidelines effective March 2024. All citizens above 12 years eligible for boosters.', true, CURRENT_TIMESTAMP),
('Flu Season Alert', 'Health ministry warns of increased flu cases. Vaccination drives starting next week across all major cities.', true, CURRENT_TIMESTAMP),
('COVID Booster Availability', 'All COVID-19 booster doses now available at designated centers. Walk-ins welcome for age group 18-65.', true, CURRENT_TIMESTAMP),
('Child Immunization Campaign', 'National campaign for routine childhood immunizations starts March 20. Free vaccines for children under 5.', true, CURRENT_TIMESTAMP),
('Health Check-up Camps', 'Free pre-vaccination health screening camps organized at all major hospitals this weekend.', true, CURRENT_TIMESTAMP);

-- Sample feedback
INSERT INTO feedback (user_id, email, subject, message, status, created_at) VALUES 
(1, 'test.user1@example.com', 'Great Service', 'Excellent vaccination experience. Staff was very helpful and professional.', 'RESPONDED', CURRENT_TIMESTAMP),
(2, 'test.user2@example.com', 'Appointment Reminder', 'Please add SMS reminders for upcoming appointments.', 'PENDING', CURRENT_TIMESTAMP);
...
INSERT INTO bookings (user_id, slot_id, status, booked_at) VALUES 
(1, 1, 'PENDING', CURRENT_TIMESTAMP),
(1, 4, 'APPROVED', CURRENT_TIMESTAMP);

-- Sample notifications for user dashboard
INSERT INTO notifications (user_id, channel, message, delivered, created_at) VALUES 
(1, 'EMAIL', 'Your booking #2 has been APPROVED! Visit City Central Hospital on March 20.', true, CURRENT_TIMESTAMP),
(1, 'SMS', 'Booking confirmation: Slot #1 PENDING. Check status in dashboard.', true, CURRENT_TIMESTAMP);
