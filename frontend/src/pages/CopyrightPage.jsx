  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://vaxzone.com/copyright" />
      </Helmet>
              ...
              <div className="card shadow-sm border-0">
                <div className="card-body p-5">
                  ...
                  <section className="mb-5">
                    <h2 className="h4 fw-bold text-dark mb-3">1. Copyright Ownership</h2>
                  ...
                  <section className="mb-5">
                    <h2 className="h4 fw-bold text-dark mb-3">2. Reporting Copyright Infringement</h2>
                    <p className="text-secondary">
