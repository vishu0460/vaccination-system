        ...
        <Row className="align-items-center">
          ...
          <Col md={4} className="text-center">
            <div className="hero-icon">
              <span style={{ fontSize: '6rem' }} role="img" aria-label="vaccine">💉</span>
            </div>
          </Col>
        </Row>
      </Container>
            ...
            {drives.map((drive, index) => (
              <Col md={4} key={drive.id} className="mb-3" style={{ animationDelay: `${index * 0.1}s` }}>
                <Card className="h-100 drive-card hover-lift">
                  ...
                  <Card.Body>
                    <Card.Title className="drive-title">{drive.title || drive.name}</Card.Title>
                    ...
                    <div className="drive-info">
                      ...
                      <p className="mb-0"><strong>👥 Age:</strong> {drive.minAge || 18} - {drive.maxAge || 60} years</p>
                    </div>
                  </Card.Body>
                  <Card.Footer>
                ...
                <Card className="h-100 center-card hover-lift">
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      <p className="mb-1">📞 {center.phone || 'N/A'}</p>
                      <p className="mb-0">🏙️ {center.city}</p>
                    </Card.Text>
                  </Card.Body>
                  <Card.Footer>
                    <div className="d-flex justify-content-between align-items-center">
