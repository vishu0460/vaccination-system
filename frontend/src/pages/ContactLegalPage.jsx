  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://vaxzone.com/contact-legal" />
      </Helmet>
                    ...
                    <div className="col-md-6 mb-3 mb-md-0">
                      <div className="d-flex align-items-start">
                        ...
                        <div>
                          ...
                          <p className="text-secondary mb-0">vaxzone.vaccine@gmail.com</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="d-flex align-items-start">
                        ...
                        <div>
                          ...
                          <p className="text-secondary mb-0">+91 9631376436</p>
